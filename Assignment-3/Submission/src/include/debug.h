...
struct debug_info{
    ...
    u32 last_num;   // The last breakpoint number assigned
    u64 backtrace[MAX_BACKTRACE];
    struct stack_element stack[MAX_BACKTRACE]; // To keep track of breakpointed functions on stack
    int stack_count;
    u8 nxt_instr;
    int pid; //pid of debugee
    struct user_regs debugee_regs;
    int rdx_change;
};
